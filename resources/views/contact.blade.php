                        ...
                        <div class="col-md-12 content-page">
                            <div class="col-md-12 blog-post">
                                ...
                                <div class="post-title margin-top-50">
                                    <h2>I hope you've checked <a href="{{ url("/work") }}" data-toggle="tooltip" data-placement="top" title="Check out my work.">my work</a>, Let's take a look on what other clients said about my work.</h2>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="testimonial-client-info">
                                            ...
                                            <div class="testimonial-client client-thumb">
                                                <img src="{{ asset("/images/testimonial/3.png") }}" alt="">
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="contact-us-detail">
                                            ...
                                            <p><a href="{{ url("tel:+1234567890") }}">+1234 567 890</a></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="contact-us-detail">
                                            ...
                                            <p><a href="{{ url("mailto:name@domain.com") }}">name@domain.com</a></p>
                                        </div>
                                    </div>
