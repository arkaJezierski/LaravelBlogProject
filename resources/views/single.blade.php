            ...
            <div class="col-md-9">
                <div class="col-md-12 page-body">
                    <div class="row">
                        ...
                        <div class="sub-title">
                            <a href="{{ url("/") }}" title="Go to Home Page"><h2>Back Home</h2></a>
                            <a href="{{ url("#comment") }}" class="smoth-scroll"><i class="icon-bubbles"></i></a>
                        </div>
                            ...
                            <div class="col-md-12 blog-post">
                                ...
                                <div class="row margin-top-40 margin-bottom-40">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <a href="{{ url("images/blog/7.jpg") }}" class="image-popup" title="image Title">
                                            <img src="{{ asset("/images/blog/7.jpg") }}" class="img-responsive" alt="">
                                        </a>
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <a href="{{ url("images/blog/5.jpg") }}" class="image-popup" title="image Title">
                                            <img src="{{ asset("/images/blog/5.jpg") }}" class="img-responsive" alt="">
                                        </a>
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <a href="{{ url("images/blog/6.jpg") }}" class="image-popup" title="image Title">
                                            <img src="{{ asset("/images/blog/6.jpg") }}" class="img-responsive" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="about-author margin-top-70 margin-bottom-50">
                                    ...
                                    <div class="picture">
                                        <img src="{{ asset("/images/blog/author.png") }}" class="img-responsive" alt="">
                                    </div>

                                    <div class="c-padding">
                                        <h3>Article By <a href="{{ url("#") }}" target="_blank" data-toggle="tooltip" data-placement="top" title="Visit Me Website">Me MEMEM</a></h3>
                                ...
                                <div class="you-may-also-like margin-top-50 margin-bottom-50">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{ url("/single") }}"><p>Make mailchimp singup form working with ajax using jquery plugin</p></a>
                                        </div>

                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{ url("/single") }}"><p>How to design elegant e-mail newsletter in html for wish christmas to your subscribers?</p></a>
                                        </div>

                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <a href="{{ url("/single") }}"><p>How to customize a wordpress theme entirely from scratch using a child theme?</p></a>
                                        </div>
...
<div id="scroll-down-popup" class="endpage-box">
    <h4>Read Also</h4>
    <a href="{{ url("#") }}">How to make your company website based on bootstrap framework...</a>
</div>
